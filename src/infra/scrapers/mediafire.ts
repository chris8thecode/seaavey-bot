 ...
 */
export async function mediafireDl(
  url: string,
): Promise<ScraperResult<MediaFireData>> {
  try {
    ...
    if (
      $("body").hasClass("errorFileMissing") ||
      $("body").hasClass("errorFileBlocked")
    ) {
